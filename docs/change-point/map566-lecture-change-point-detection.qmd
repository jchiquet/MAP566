...
plot_segmentation <- function(data, segmentation, Kopt) {
  ...
  Topt <- c(0,segmentation$Test[(Kopt-1),1:(Kopt-1)],n)
...
#| code-fold: true
p1 <- plot_segmentation(d, r, 3) + ggtitle("K = 3")
p2 <- plot_segmentation(d, r, 6) + ggtitle("K = 6")
p3 <- plot_segmentation(d, r, 9) + ggtitle("K = 9")
p4 <- plot_segmentation(d, r, 12) + ggtitle("K = 12")
p5 <- plot_segmentation(d, r, 15) + ggtitle("K = 15")
p6 <- plot_segmentation(d, r, 20) + ggtitle("K = 20")
...
```{r}
#| code-fold: true
pl <- ggplot(data=r$obj) + geom_line(aes(K,U), linewidth=1, colour="purple")+ 
